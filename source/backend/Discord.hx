...
class DiscordClient
{
	...
	private static final _defaultID:String = "1266093878860058645";
	...
	public static function changePresence(?details:String = 'In the Menus', ?state:Null<String>, ?smallImageKey : String, ?hasStartTimestamp : Bool, ?endTimestamp: Float)
	{
		...
		presence.largeImageText = "Newbie's Psych Engine v" + states.MainMenuState.newbiesPsychEngineVersion;
